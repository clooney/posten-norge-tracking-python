# Posten Norge Tracking API For Python
Posten Norge Tracking API and webhook make it easy to integrate Posten Norge Tracking function into your own project. Support APIs Client Libraries for python

### API key

In order to use this API, you need to generate a Posten Norge Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Posten Norge Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Posten Norge Tracking API](https://www.trackingmore.com/posten-norge-tracking.html)  to:

   *   Get Posten Norge realtime tracking info of muti-carriers in one integration
   *   Provide Posten Norge shipment tracking experience like Amazon
   *   Push Posten Norge notifications of package update with webhook
   *   Verify Posten Norge delivery exception before it is too late
